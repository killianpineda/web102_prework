...
const unfundedGamesStr = `A total of ${totalRaised} has been raised for ${GAMES_JSON.length} games. 
...
newPar.innerHTML = `<p>${unfundedGamesStr}</p>`;

descriptionContainer.append(newPar);
...
firstGamePar.innerHTML = `<p>${firstGame.name}</p>`;
firstGameContainer.append(firstGamePar);

// do the same for the runner up item
const secondGamePar = document.createElement('p');
secondGamePar.innerHTML = `<p>${secondGame.name}</p>`;
secondGameContainer.append(secondGamePar);